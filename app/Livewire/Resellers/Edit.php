...
class Edit extends Component
{
    ...
    public function rules()
    {
        return [
            ...
            'reseller.country_id' => 'required|exists:countries,id',
            'reseller.phone' => 'required',
            'reseller.payment_method' => 'required',
            // Billing
    ...
    public function save()
    {
        ...
        $this->reseller->update([
            ...
            'country_id' => $this->reseller->country_id,
            'phone' => $this->reseller->phone,
            'payment_method' => $this->reseller->payment_method,
        ]);
