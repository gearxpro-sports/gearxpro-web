    ...
    <div class="space-y-2">
        ...
        <a href="{{ route('customers.index') }}"
           class="{{ request()->is('customers*') ? 'text-color-323a46' : 'text-color-6c757d hover:text-color-323a46' }} group flex items-center px-2 py-2 text-sm font-medium rounded-md">
            <x-icons name="user-w-search" class="{{ request()->is('customers*') ? 'text-color-323a46' : 'text-color-6c757d group-hover:text-color-323a46' }} mr-3 flex-shrink-0 h-5 w-5" />
    ...
    <div>
        <a href="#"
           class="{{ request()->is('settings*') ? 'text-color-323a46' : 'text-color-6c757d hover:text-color-323a46' }} group flex items-center px-2 py-2 text-sm font-medium rounded-md">
            <x-icons name="gear" class="{{ request()->is('settings*') ? 'text-color-323a46' : 'text-color-6c757d group-hover:text-color-323a46' }} mr-3 flex-shrink-0 h-5 w-5" />
