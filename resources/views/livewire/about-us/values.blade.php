<div class="grid grid-cols-2 gap-x-7">
    <div class="col-span-2 grid grid-cols-2 grid-rows-6 h-[984px] bg-about_us_values_1 relative">
    ...
    <div class="col-span-2 grid grid-cols-2 grid-rows-6 h-[1080px] bg-about_us_values_2 relative">
    ...
    <div class="col-span-2 grid grid-cols-2 grid-rows-6 h-[1080px] bg-about_us_values_3 relative">
        <div class="absolute top-0 left-0 w-full h-full bg-black/50"></div>
