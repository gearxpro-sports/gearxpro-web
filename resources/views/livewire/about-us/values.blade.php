    ...
    <div id="pagepiling">
        <div class="section relative grid grid-cols-12 grid-rows-6 overflow-hidden">
            ...
            <div class="z-10 row-start-2 xl:row-start-4 col-start-2 col-span-10 pt-14 xl:pt-10">
                <h3 class="text-center text-2xl xl:text-[59px] font-bold leading-10 xl:leading-[124px] tracking-[0px] text-white mb-3">Uniquenessddddd, Integrity, Environment and Respect.</h3>
