<div class="min-w-[594px] max-w-[594px] h-[727px] rounded-b-md overflow-hidden">
    <div class="w-full h-[calc(100%-108px)] bg-white flex items-center justify-center overflow-hidden">
        <img src="{{ Vite::asset('resources/images/SOXPro.png')}}" alt="">
    </div>
    <div class="bg-white h-[108px] w-full flex border border-white border-x border-x-white hover:border-y-white rounded-b-md transition-all duration-300 group">
        ...
        <div class="h-full w-[88px] flex items-center justify-center border-l rounded-br-md border-white group-hover:border-white group-hover:bg-color-edebe5 transition-all duration-500">
