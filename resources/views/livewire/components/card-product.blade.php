<div
    @class([
        ...
        $cardSmall ? '!w-[434px] max-w-[434px] h-[561px]' : '!w-[594px] max-w-[594px] h-[727px]',
    ])
 >
    ...
    <div class="bg-white h-[108px] flex border border-white border-x border-x-white hover:border-y-white rounded-b-md transition-all duration-300 group">
        <div class="h-full grow flex flex-col px-[20px] py-[16px] relative">
            ...
            <p class="z-10 text-[12px] font-medium text-color-6c757d line-clamp-1">{{ $description }}</p>
        ...
        <a href="{{route('shop.show', $slug)}}" class="h-full min-w-[88px] flex items-center justify-center border-l rounded-br-md border-white group-hover:border-white group-hover:bg-color-edebe5 transition-all duration-500">
