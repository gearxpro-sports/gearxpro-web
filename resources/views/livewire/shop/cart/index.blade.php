<div class="pt-[70px] px-[39px] bg-color-f2f0eb pb-[150px]">

    {{-- carrello --}}
    <div class="grid grid-cols-12 mb-[150px]">
        {{-- info carrello --}}
        ...
        <div class="col-span-8 mt-[55px]">
            ...
            <div class="w-[1160px] h-[2px] bg-color-ff7f6e mt-[27px] mb-[24px]"></div>
        ...
        <div class="col-span-3">
            ...
            <div class="bg-color-edebe5 w-full h-[48px] flex items-center justify-between px-5 rounded-md mt-[15px]">
                ...
                <button class=" text-[12px] font-medium leading-[15px] text-color-6c757d">{{ __('shop.cart.apply')}}</button>
            </div>
