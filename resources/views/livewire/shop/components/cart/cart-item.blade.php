<div class="flex flex-col md:flex-row border-b xl:border border-color-e0e0df relative mb-5 pb-5 xl:pb-0 xl:mb-1">

    <div class="flex xl:flex-1 xl:p-1 gap-7">
        <div class="w-20 h-20 md:w-40 md:h-40 xl:w-48 xl:h-48">
    ...
    <div class="w-fit xl:px-5 mx-auto md:ml-auto md:mr-0 lg:mx-auto mt-4 xl:mt-0 xl:m-0 xl:border-x border-color-e0e0df flex items-center justify-center">
        <div class="w-full h-[48px] rounded-md flex items-center border border-color-b6b9bb">
            ...
            <div class="w-16 md:w-32 h-full flex items-center justify-center text-[13px] font-medium leading-[16px] text-color-18181a font-mono select-none">{{ $item->quantity }}</div>
    ...
    <div class="absolute lg:static bottom-10 md:bottom-auto  md:top-0 right-4 lg:w-36 flex items-center justify-center">
        <div wire:click="remove" class="text-xs font-medium text-color-6c757d cursor-pointer">
            <div class="flex items-center space-x-2 xl:space-x-1">
                <span class="hidden md:block">{{ __('shop.cart.remove')}}</span>
