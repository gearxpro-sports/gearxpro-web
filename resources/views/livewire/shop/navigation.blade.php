...
{{--                    </x-nav-link>--}}
                    ...
                    <x-nav-link :href="route('about_us.partnership', ['country_code' => session('country_code')])" :active="request()->routeIs('about_us.partnership')">
                        {{ __('shop.navigation.partnership') }}
                    </x-nav-link>
...
{{--                        @endif--}}
    ...
    >
        ...
        <div class="flex flex-col gap-6">
            ...
            <a href="{{ route('about_us.partnership', ['country_code' => session('country_code')]) }}" class="text-[17px] font-semibold leading-[20px] text-color-18181a">{{ __('shop.navigation.partnership') }}</a>
