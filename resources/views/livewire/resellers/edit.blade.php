    ...
    <form wire:submit="save" class="bg-white space-y-10 p-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <x-input type="text" wire:model="billing_address.company" name="company" label="{{ __('resellers.create.company.label') }}"
                     required></x-input>
            <x-select wire:model="reseller.country_id" hint="{{ __('resellers.create.country.hint') }}" name="country_id"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <x-select wire:model="reseller.payment_method" name="payment_method"
