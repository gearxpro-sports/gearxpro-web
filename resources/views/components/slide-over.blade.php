...
<div x-data="{ open: false }" @close-slide-over="open = false">
	...
	<div x-show="open" class="fixed inset-0 z-[90]">
		<div
			x-cloak
			x-show="open"
		...
		<div
			...
			<div class="flex items-center h-16">
				<div class="w-full flex justify-between items-center {{ $from === 'left' ? '' : 'flex-row-reverse' }}">
					<button @click="open = false; Livewire.emit('closed')" type="button" class="inline-flex items-center justify-center p-0.5 sm:p-2.5 -ml-2 text-gray-400 rounded-md hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-600" aria-expanded="false">
