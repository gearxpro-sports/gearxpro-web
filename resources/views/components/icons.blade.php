...
@switch($name)
    ...
    @case('eye')
        ...
        @break
    @case('eye-gray')
        <svg id="icona_eye_ON" data-name="icona eye ON" xmlns="http://www.w3.org/2000/svg" width="16.717" height="12.5" viewBox="0 0 16.717 12.5">
    ...
    @case('eye-off')
        ...
        @break
    @case('eye-off-gray')
        <svg id="icona_eye_OFF" data-name="icona eye OFF" xmlns="http://www.w3.org/2000/svg" width="17.385" height="15.369" viewBox="0 0 17.385 15.369">
            <path id="Tracciato_252" data-name="Tracciato 252" d="M20.834,12.942a12.236,12.236,0,0,0-2.5-3.613l-1.014,1.014a10.671,10.671,0,0,1,2.171,3.113c-1.659,3.433-4.014,5.064-7.232,5.064a7.717,7.717,0,0,1-2.669-.446l-1.1,1.1a8.882,8.882,0,0,0,3.768.783q5.748,0,8.578-5.988a1.2,1.2,0,0,0,0-1.027ZM19.567,6.548l-.85-.851a.16.16,0,0,0-.226,0l-2.181,2.18a8.782,8.782,0,0,0-4.054-.921q-5.748,0-8.578,5.988a1.2,1.2,0,0,0,0,1.027A11.973,11.973,0,0,0,6.4,17.787L4.291,19.9a.16.16,0,0,0,0,.226l.851.851a.16.16,0,0,0,.226,0l14.2-14.2a.16.16,0,0,0,0-.226ZM5.025,13.456c1.661-3.433,4.016-5.064,7.232-5.064a7.548,7.548,0,0,1,2.973.566l-1.4,1.4A3.509,3.509,0,0,0,9.08,15.107L7.417,16.771A10.352,10.352,0,0,1,5.025,13.456Zm4.919,0a2.235,2.235,0,0,1,2.915-2.127L10.05,14.138A2.233,2.233,0,0,1,9.944,13.456Z" transform="translate(-3.564 -5.651)" fill="#b6b9bb"/>
            <path id="Tracciato_253" data-name="Tracciato 253" d="M22.116,24.537c-.069,0-.137,0-.2-.009L20.858,25.58a3.511,3.511,0,0,0,4.534-4.534L24.34,22.1c.006.067.009.135.009.2a2.232,2.232,0,0,1-2.233,2.233Z" transform="translate(-13.503 -14.498)" fill="#b6b9bb"/>
        </svg>
        @break
    @case('filter')
    ...
    @break
    @case('delivery')
        <svg id="icona_Recapiti_e_Consegna_ON" data-name="icona Recapiti e Consegna ON" xmlns="http://www.w3.org/2000/svg" width="23.273" height="16" viewBox="0 0 23.273 16">
            <path id="Tracciato_256" data-name="Tracciato 256" d="M0,9v1.455H13.818V21.364H9.341a2.882,2.882,0,0,0-5.591,0H2.909V17.727H1.455v5.091h2.3a2.882,2.882,0,0,0,5.591,0h6.045a2.882,2.882,0,0,0,5.591,0h2.3V16.887l-.046-.114-1.455-4.364-.158-.5H15.273V9Zm.727,2.909v1.455H7.273V11.909Zm14.545,1.455h5.3l1.25,3.727v4.273h-.841a2.882,2.882,0,0,0-5.591,0h-.113ZM1.455,14.818v1.455H5.818V14.818Zm5.091,5.818a1.455,1.455,0,1,1-1.455,1.455A1.443,1.443,0,0,1,6.545,20.636Zm11.636,0a1.455,1.455,0,1,1-1.455,1.455A1.443,1.443,0,0,1,18.182,20.636Z" transform="translate(0 -9)" fill="#fff"/>
        </svg>
    @break
    @case('delivery-off')
        <svg id="icona_Recapiti_e_Consegna_OFF" data-name="icona Recapiti e Consegna OFF" xmlns="http://www.w3.org/2000/svg" width="23.273" height="16" viewBox="0 0 23.273 16">
    ...
    @break
    @case('payment')
        <svg id="icona_Info_Pagamento_ON" data-name="icona Info Pagamento ON" xmlns="http://www.w3.org/2000/svg" width="17.848" height="15.199" viewBox="0 0 17.848 15.199">
    ...
    @break
    @case('payment-off')
        <svg id="icona_Info_Pagamento_OFF" data-name="icona Info Pagamento OFF" xmlns="http://www.w3.org/2000/svg" width="17.848" height="15.199" viewBox="0 0 17.848 15.199">
    ...
    @break
    @case('flag_ON')
        <svg id="flag_ON" data-name="flag ON" xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17">
