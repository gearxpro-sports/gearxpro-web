...
@switch($name)
    ...
    @case('check-format')
        <svg xmlns="http://www.w3.org/2000/svg" width="12.069" height="9" viewBox="0 0 12.069 9"
            ...
            <path id="Tracciato_254" data-name="Tracciato 254" d="M4.1,14.926.177,11a.6.6,0,0,1,0-.853L1.03,9.3a.6.6,0,0,1,.853,0l2.642,2.642,5.66-5.66a.6.6,0,0,1,.853,0l.853.853a.6.6,0,0,1,0,.853l-6.94,6.94a.6.6,0,0,1-.853,0Z" transform="translate(0 0)" fill="#15af2d"/>
            </g>
        </svg>
        @break
    @case('check-product')
    ...
    @case('arrow-down-bold')
        <svg id="arrow-down-bold" xmlns="http://www.w3.org/2000/svg" width="6.955" height="4" viewBox="0 0 6.955 4"
            {{ $attributes->merge(['class']) }}>
            <path id="Tracciato_2" data-name="Tracciato 2" d="M4.183,15.155a.522.522,0,0,1,.739,0l2.586,2.586,2.586-2.586a.522.522,0,1,1,.739.739L7.877,18.849a.522.522,0,0,1-.739,0L4.183,15.893a.522.522,0,0,1,0-.739Z" transform="translate(-4.03 -15.002)" fill="#18181a"/>
        </svg>
        @break
    @case('round_arrow')
    ...
    @case('minus_menu')
        <svg id="icona_minus_menu" data-name="icona minus menu" xmlns="http://www.w3.org/2000/svg" width="12.3" height="1.3" viewBox="0 0 12.3 1.3"
            ...
            <path id="Tracciato_236" data-name="Tracciato 236" d="M19,24.65H8a.65.65,0,1,1,0-1.3H19a.65.65,0,0,1,0,1.3Z" transform="translate(-8 -24)" fill="#18181a"/>
            </g>
        </svg>
        @break
    @case('delete')
