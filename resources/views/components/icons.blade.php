...
@switch($name)
    ...
    @case('round_arrow_active')
        ...
        @break
    @case('facebook')
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="8.827" height="17" viewBox="0 0 8.827 17"
            {{ $attributes->merge(['class']) }}>
        ...
        @break
    @case('linkedin')
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="17.785" height="17" viewBox="0 0 17.785 17"
            {{ $attributes->merge(['class']) }}>
        ...
        @break
    @case('youTube')
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="18.194" height="22" viewBox="0 0 18.194 22"
            {{ $attributes->merge(['class']) }}>
        ...
        @break
    @case('instagram')
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="17" height="17" viewBox="0 0 17 17"
            {{ $attributes->merge(['class']) }}>
