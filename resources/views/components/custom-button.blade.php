...
<a href="{{ $link }}" @class(["min-w-[224px] w-fit h-[48px] bg-white rounded-md flex justify-between items-center border border-black hover:border-white group", $width])>
    <div class="h-full flex items-center grow relative group-hover:text-white">
        <span class="z-10 mx-5 xl:ml-9 text-[15px] font-semibold">{{$text}}</span>
